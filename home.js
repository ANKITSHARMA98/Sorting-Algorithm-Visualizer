...
function disSortingBtn() { // if sorting in process disable rest of button
...
document.querySelector(".reset").disabled = true; // reset function is only on during the algo running defaunt itss off
function disResetBtn() {
  document.querySelector(".reset").disabled = true; // after running algos reset will be enable 
}
...
function genNewArray(noOfBars = 60) { 
